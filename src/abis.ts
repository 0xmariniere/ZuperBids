// Generated by @wagmi/cli@0.1.15 on 5/23/2023 at 2:22:04 PM
import {
  getContract,
  GetContractArgs,
  readContract,
...
export const zupaBidsABI = [
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: 'telegramId', internalType: 'string', type: 'string' },
    ],
  },
  {
    stateMutability: 'view',
  ...
  },
  {
    ...
    outputs: [
      {
        name: '',
        internalType: 'struct ZupaBids.Auction[]',
        type: 'tuple[]',
        components: [
          { name: 'tokenId', internalType: 'uint256', type: 'uint256' },
          { name: 'endTime', internalType: 'uint256', type: 'uint256' },
...
/**
 * Wraps __{@link getContract}__ with `abi` set to __{@link zupaBidsABI}__.
 */
export function getZupaBids(config: Omit<GetContractArgs, 'abi'>) {
  return getContract({ abi: zupaBidsABI, ...config })
}

/**
 * Wraps __{@link readContract}__ with `abi` set to __{@link zupaBidsABI}__.
 */
export function readZupaBids<TAbi extends readonly unknown[] = typeof zupaBidsABI, TFunctionName extends string = string>(
  config: Omit<ReadContractConfig<TAbi, TFunctionName>, 'abi'>
) {
  return readContract({ abi: zupaBidsABI, ...config } as unknown as ReadContractConfig<TAbi, TFunctionName>)
}

/**
 * Wraps __{@link writeContract}__ with `abi` set to __{@link zupaBidsABI}__.
 */
export function writeZupaBids<TFunctionName extends string>(
  config:
    | Omit<WriteContractPreparedArgs<typeof zupaBidsABI, TFunctionName>, 'abi'>
    | Omit<WriteContractUnpreparedArgs<typeof zupaBidsABI, TFunctionName>, 'abi'>
) {
  return writeContract({ abi: zupaBidsABI, ...config } as WriteContractArgs<typeof zupaBidsABI, TFunctionName>)
}

/**
 * Wraps __{@link prepareWriteContract}__ with `abi` set to __{@link zupaBidsABI}__.
 */
export function prepareWriteZupaBids<TAbi extends readonly unknown[] = typeof zupaBidsABI, TFunctionName extends string = string>(
  config: Omit<PrepareWriteContractConfig<TAbi, TFunctionName>, 'abi'>
) {
  return prepareWriteContract({ abi: zupaBidsABI, ...config } as unknown as PrepareWriteContractConfig<TAbi, TFunctionName>)
}

/**
 * Wraps __{@link watchContractEvent}__ with `abi` set to __{@link zupaBidsABI}__.
 */
export function watchZupaBidsEvent<TAbi extends readonly unknown[] = typeof zupaBidsABI, TEventName extends string = string>(
  config: Omit<WatchContractEventConfig<TAbi, TEventName>, 'abi'>,
  callback: WatchContractEventCallback<TAbi, TEventName>
) {
  return watchContractEvent({ abi: zupaBidsABI, ...config } as WatchContractEventConfig<TAbi, TEventName>, callback)
}
